...
def middle_way(a, b):
  ...
  half_b = int(len(b) / 2)
  lista = list()
  lista.append(a[half_a])
  lista.append(b[half_b])
  return lista
...
def pego_correndo(speed, is_birthday):
  if speed <= 60 and is_birthday == False or speed <= 65 and is_birthday == True:
    return 0 
  elif 81 >= speed >= 61 and is_birthday == False or 86 >= speed >= 66 and is_birthday == True:
    return 1
...
def alarm_clock(day, vacation):
  if 5 >= day >= 1 and vacation == False:
    return '7:00'
  elif 5 >= day >= 1 and vacation == True or day == 6 and vacation == False or day == 0 and vacation == False:
    return '10:00'
